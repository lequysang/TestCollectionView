...
- (void)viewDidLoad
{
    ...
    firstCollectionFrame.size.height = 60.0f;
    ...
    firstFlowLayout.itemSize = CGSizeMake(57.0f, 57.0f);
    ...
    [firstCollectionView setBackgroundColor:[UIColor underPageBackgroundColor]];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)cv cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell setImageURL:[self.collectionData objectAtIndex:indexPath.row]];
